        ...
        return (
            <div id="SMLessonPage_Lessons">
                <div class="SMLessonPage_Lessons_flex-container">
                    <div class="SMLessonPage_Lessons_benefits">
                        ...
                        <p>
                            ...
                            This helps both the companies (like social media sites) hosting ads stay in business while providing a platform for companies to showcase their products to interested individuals. <br/><br/>
                    ...
                    <div class="SMLessonPage_Lessons_harms">
                        ...
                        Because of those actions, 126 million individuals were reached through disinformation advertisements.
                        </p>
                    </div>
                </div>
                <div class="SMLessonPage_Lessons_soWhat">
                    ...
                    The Russian Ads were targeted towards individuals that were passionate about polarizing topics.The language and formats used in the advertisements were meant to inflate the polarized ideas that individuals had, causing them to develop more intense feelings.This was then exploited through disinformation, or information that was intended on misleading an individual through malicious means. <br/><br/>
                    The advertisements were a vector for disinformation, and the reach that social media ads provided for them caused worldwide impact. <br/><br/>
